  ...
  return (
    <div className="min-h-screen bg-[#000B58] flex items-center justify-center relative px-4">
      ...
      <div className="flex items-center justify-center relative max-w-6xl mx-auto">
        ...
        {/* Content Box */}
        <div className="bg-[#98DED9] p-8 md:p-12 shadow-lg w-full max-w-3xl z-10 relative ml-[-50px] md:ml-[-80px] flex">
          {/* Example Text */}
          <div className="flex-none mr-4 md:mr-20">
            <p></p>
          </div>
          {/* About Me Content */}
          <div className="mr-4">
            <h1 className="text-3xl font-kalnia mb-10">ABOUT ME</h1>
